...
def prepare_osm(
    ...
    geojson_path = "/home/kevinmeng/workspace/mappedin/VPS/OrienterNet/maploc/data/yyc/yyc_scan.geojson"
    ...
    plotter.points(all_latlon, "red", name="OSM Points")
    ...
    plotter.fig.write_html(f"yyc_data_vis_{floor_id}.html")
